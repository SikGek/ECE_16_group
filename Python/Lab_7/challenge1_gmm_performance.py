...
from sklearn.metrics import explained_variance_score as exp
import math as m
...
if __name__ == "__main__":
  ...
  rmse = m.sqrt(mse(hr_1, hr_2))
  [R, p] = stats.pearsonr(hr_1, hr_2)
  #log_l = ll(hr_1, hr_2)
  r2 = r2_s(hr_1, hr_2)
  evs = exp(hr_1, hr_2)
  print("RMSE: ", rmse, " Correlation: ", R, " R2 Score: ", r2, " Explained Variance Score: ", evs) #+ " Precision: " + pre)
  #plt.subplot(211)
  plt.plot(hr_2, hr_2)
  plt.scatter(hr_1, hr_2)
